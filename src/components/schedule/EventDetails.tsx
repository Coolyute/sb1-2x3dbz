...
export function EventDetails({ eventName, category, onClose }: EventDetailsProps) {
  ...
  const isFinal = category.toLowerCase().includes('final');
  ...
  const finalists = isFinal ? getFinalists() : [];
